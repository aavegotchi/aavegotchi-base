...
contract ItemsTransferFacet is Modifiers {
    ...
    */
    ...
    function extractItemsFromDiamond(address _to, uint256[] calldata _itemIds, uint256[] calldata _values) public onlyItemManager {
        address sender = LibMeta.msgSender();
    ...
    function batchExtractItemsFromDiamond(address[] calldata _tos, uint256[][] calldata _ids, uint256[][] calldata _values) external onlyItemManager {
